from flaskProject.src.dam.data_analysis.service.titanic.template import Plot
from flaskProject.src.dam.data_analysis.service.titanic.views import TitanicController
